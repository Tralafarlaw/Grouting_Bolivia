package com.amuyu.groutingbolivia.customcomponents
...
class FabBottomNavigationView @JvmOverloads constructor(
    ...
    init {
        ...
        topCurvedEdgeTreatment = BottomAppBarTopEdgeTreatment(fabCradleMargin, fabCradleRoundedCornerRadius, cradleVerticalOffset).
        apply {
            this.fabDiameter = fabSize
        }
            ...
            fab.hide(object : FloatingActionButton.OnVisibilityChangedListener() {
                override fun onHidden(fab: FloatingActionButton?) {
                    ...
                    ValueAnimator.ofFloat(materialShapeDrawable.interpolation, 0F).apply {
                        this.addUpdateListener { materialShapeDrawable.interpolation = it.animatedValue as Float }
                        start()
                    }
                }
            })
